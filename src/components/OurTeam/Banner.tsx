...
const Banner: React.FC = () => {
    ...
    return (
        ...
        <p className="text-white text-sm sm:text-lg leading-6 font-light font-rubik">We are a multidisciplinary team of passionate professionals committed to producing top-tier work.</p>
