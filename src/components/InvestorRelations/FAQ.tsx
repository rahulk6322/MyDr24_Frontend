        ...
        <section className="md:mt-10 mt-4">
            ...
            <div className="w-full mx-auto bg-white rounded-lg p-3">
                {collapsibleData.map((section, index) => (
                    <div
                        key={index}
                        className="mb-2 border-[0.5px] border-[#0065B266] rounded-md px-2 py-2"
                    >
                        {/* Collapsible Header */}
                        <div
                        ...
                        >
                            <h2 className="md:text-[15px]  text-sm font-medium  font-rubik  ">
                                {section.title}
                            </h2>
                            <span
                            ...
                            >
                                <div className="border-l border-t border-black w-[10px] h-[10px] transform rotate-45 "></div>
                            </span>
                        </div>
